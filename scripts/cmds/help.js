...
module.exports = {
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      msg += `╔═════▓࿇࿇▓═════╗\n             𝐀𝐋𝐋 𝐂𝐌𝐃 𝐋𝐈𝐒𝐓 𝗜𝗡 𝐃𝐢𝐝𝐚𝐫 𝐄𝐢𝐧𝐬𝐭𝐞𝐢𝐧'𝐬\n╚═════▓࿇࿇▓═════╝\n\n`;
      ...
      msg += `👑 | 𝐓𝐇𝐀𝐍𝐊𝐒 𝐅𝐎𝐑 𝐔𝐒𝐈𝐍𝐆 𝐃𝐢𝐝𝐚𝐫 𝐄𝐢𝐧𝐬𝐭𝐞𝐢𝐧'𝐬 𝐖𝐄'𝐋𝐋 𝐂𝐎𝐌𝐄 𝐖𝐈𝐓𝐇 𝐍𝐄𝐖 𝐔𝐏𝐃𝐀𝐓𝐄 𝐄𝐕𝐄𝐑𝐘 𝐖𝐄𝐄𝐊`;
      ...
      if (!command) {
        ...
        const response = `╭── 𝐍𝐀𝐌𝐄 𝐎𝐖𝐍𝐄𝐑 - 𝐃𝐢𝐝𝐚𝐫 𝐄𝐢𝐧𝐬𝐭𝐞𝐢𝐧'𝐬 ────⭓
  │ ${configCommand.name}
  ├── INFO
  ...
  │ ${usage}
  ├── Notes
  │ THIS BOT HAS BEEN MADE BY 𝐃𝐢𝐝𝐚𝐫 𝐄𝐢𝐧𝐬𝐭𝐞𝐢𝐧'𝐬
  │ FOR ANY HELP YOU CAN CONTACT OWNER: https://www.facebook.com/Didar.Einstein12
  ╰━━━━━━━❖`;
